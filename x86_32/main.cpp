...
extern "C" int find_markers(unsigned char *bitmap, unsigned char *used, unsigned int *x_pos, unsigned int *y_pos);
...
int main(int argc, const char *argv[])
{
    ...
    int amount = find_markers(data, used, x_coord, y_coord);
